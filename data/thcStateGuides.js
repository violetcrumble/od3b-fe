const THC_STATE_GUIDES = [
  ...
  },
  {
    ...
    metaDescription:
      'Yes. Delta-9 hemp drinks are legal in Indiana under the federal default and brands ship here. What the delta-8 legal fog means and what changes in December 2026.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Indiana’s hemp reputation for legal murkiness is real, but it is about a different molecule. In 2023 Attorney General Todd Rokita issued an opinion calling delta-8 THC a Schedule I controlled substance, and the legislature has fought over synthetic cannabinoids ever since; a 2026 bill to ban them outright failed to pass.\n\nDelta-9 drinks sit outside that fight. They use the exact cannabinoid the federal hemp definition names, at the compliance threshold it sets, with no conversion chemistry for an attorney general to attack. It is the cleanest legal lane hemp THC has in Indiana. [Willie’s Remedy](/thc-drinks/reviews/willies-remedy-review), the brand readers ask us about most, sits on that side of the line.',
      },
      {
        heading: 'Do brands ship THC drinks to Indiana?',
        body: 'Yes. Brands ship to Indiana under the same federal default that covers in-store sales, and it is a routine ship-to state for the national names. [Grind With Gratitude](https://grindwithgratitude.com/collections?ref=cocktailunderground&utm_source=cocktailunderground&utm_medium=legal_states_inline&utm_campaign=legal-states-indiana), the brand we have reviewed most, ships here, and their checkout page is the final word for your address. Ship-to lists change without notice, so it is worth checking that against [anything else we have vetted](/thc-drinks/discounts) before you order.',
      },
      {
        heading: 'The December 2026 federal ban',
        body: 'The federal hemp redefinition caps hemp products at 0.4mg of total THC per container, and for drinks it now lands **December 11, 2026** rather than November 12, after the president signed the funding bill carrying the delay on September 2, 2026. Because Indiana leans entirely on the federal definition and has no marijuana program as a fallback, this hits harder here than almost anywhere: no retail, no shipping, no dispensary alternative. Indiana goes from one of the easiest states to one of the hardest overnight. The delta-8 products at the centre of Indiana’s long legal fight did not get the extra month and still lose hemp status on **November 12, 2026**.\n\nIf you want a stock of something you already like before that date, the two we have tested at this dose are [Grind With Gratitude](https://grindwithgratitude.com/collections?ref=cocktailunderground&utm_source=cocktailunderground&utm_medium=legal_states_inline&utm_campaign=legal-states-indiana&utm_content=ban_stockup) and [Crescent Canna](https://www.awin1.com/cread.php?awinmid=129383&awinaffid=2989155&ued=https%3A%2F%2Fwww.crescentcanna.com%2F&clickref=legal_states_inline_legal-states_indiana_ban_stockup). The full picture is in our [federal THC drink ban explainer](/blog/thc-drink-ban-november-2026).',
      },
    ],
    faqs: [
      {
