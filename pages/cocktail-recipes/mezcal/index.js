...
import { GET_ALL_MEZCAL_RECIPES } from '../../../graphql/queries.js';
...
export default function MezcalRecipes({ recipes }) {
  

  return (
    <ContentWrapper>
      <Head>
        <title>Cocktail Underground - Mezcal Cocktail Recipes</title>
        ...
        <meta property="og:title" content="Cocktail Underground - Mezcal Cocktail Recipes" />
        <meta property="og:description" content="How to make craft cocktails at home" />
      </Head>

      <ContentWrapperConstrainedStyles>
        <main>
          <h1>Mezcal Cocktail Recipes</h1>
