...
import { GET_ALL_CACHACA_RECIPES } from '../../../graphql/queries.js';
...
export default function CachacaRecipes({ recipes }) {
  

  return (
    <ContentWrapper>
      <Head>
        <title>Cocktail Underground - Cachaça Cocktail Recipes</title>
        ...
        <meta property="og:title" content="Cocktail Underground - Cachaça Cocktail Recipes" />
        <meta property="og:description" content="How to make craft cocktails at home" />
      </Head>

      <ContentWrapperConstrainedStyles>
        <main>
          <h1>Cachaça Cocktail Recipes</h1>
