...
import { GET_ALL_TEQUILA_RECIPES } from '../../../graphql/queries.js';
...
export default function TequilaRecipes({ recipes }) {
  

  return (
    <ContentWrapper>
      <Head>
        <title>Cocktail Underground - Tequila Cocktail Recipes</title>
        ...
        <meta property="og:title" content="Cocktail Underground - Tequila Cocktail Recipes" />
        <meta property="og:description" content="How to make craft cocktails at home" />
      </Head>

      <ContentWrapperConstrainedStyles>
        <main>
          <h1>Tequila Cocktail Recipes</h1>
