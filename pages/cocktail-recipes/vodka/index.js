...
import { GET_ALL_VODKA_RECIPES } from '../../../graphql/queries.js';
...
export default function VodkaRecipes({ recipes }) {
  

  return (
    <ContentWrapper>
      <Head>
        <title>Cocktail Underground - Vodka Cocktail Recipes</title>
        ...
        <meta property="og:title" content="Cocktail Underground - Vodka Cocktail Recipes" />
        <meta property="og:description" content="How to make craft cocktails at home" />
      </Head>

      <ContentWrapperConstrainedStyles>
        <main>
          <h1>Vodka Cocktail Recipes</h1>
