...
import { GET_ALL_RUM_RECIPES } from '../../../graphql/queries.js';
...
export default function RumRecipes({ recipes }) {
  

  return (
    <ContentWrapper>
      <Head>
        <title>Cocktail Underground - Rum Cocktail Recipes</title>
        ...
        <meta property="og:title" content="Cocktail Underground - Rum Cocktail Recipes" />
