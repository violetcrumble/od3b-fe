  ...
  return (
    <ContentWrapper>
      ...
      <div className="constrained-content">
        ...
        <ul>
          <li>
            <a href="https://amzn.to/48Y63xG" target="_blank" rel="sponsored noopener noreferrer">
              MOUNTDOG Softbox Lighting Kit, Photography Studio Light
            </a>
          </li>
          <li>
            <a href="https://amzn.to/497ukCB" target="_blank" rel="sponsored noopener noreferrer">
              COMICA VM30 Wireless Shotgun Microphone for Camera
            </a>
          </li>
          <li>
            <a href="https://amzn.to/4ahDwW2" target="_blank" rel="sponsored noopener noreferrer">
              GLEAM Microphone Stand for Light Microphone (less than 1 LB)
            </a>
          </li>
          <li>
            <a href="https://amzn.to/49bJk2f" target="_blank" rel="sponsored noopener noreferrer">
              NEEWER X12 14 inch Aluminum Alloy Teleprompter for iPad/Tablet/Smartphone/DSLR Cameras
            </a>
          </li>
          <li>
            <a href="https://amzn.to/4pW4tUp" target="_blank" rel="sponsored noopener noreferrer">
              Satechi Bluetooth Remote Control - R2 (for controlling teleprompter)
            </a>
          </li>
          <li>
            <a href="https://amzn.to/48CaG1o" target="_blank" rel="sponsored noopener noreferrer">
              Chuangdi 2 Sets Acrylic Display Risers
            </a>
          </li>
          <li>
            <a href="https://amzn.to/4rVN5jN" target="_blank" rel="sponsored noopener noreferrer">
